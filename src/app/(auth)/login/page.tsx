...
export default function LoginPage() { return <AuthPage title="Welcome back" note="Sign in to manage your teams."><AuthForm mode="login"/><p className="mt-5 text-center text-sm muted">New here? <Link className="text-emerald-300" href="/register">Create an account</Link></p></AuthPage> }
